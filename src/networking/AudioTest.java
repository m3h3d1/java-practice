...
public class AudioTest {
    public static void main(String[] args) {
        ...
        try {
            ...
            AudioInputStream audio = AudioSystem.getAudioInputStream(url); // get stream from url
            DataLine.Info info = new DataLine.Info(Clip.class, audio.getFormat()); // info needed for line
